...
["sl", "szl", "sk", "ur", "fy-NL", "mai", "xcl", "sw", "kab", "uz", "sc", "pl", "ca-valencia", "vi", "sq", "he", "ms", "km", "nn-NO", "be", "es-ES", "da", "gn", "mr", "kk", "trs", "es-CL", "ixl", "ja-JP-mac", "ja", "el", "sco", "lv", "es-AR", "oc", "it", "ca", "is", "cs", "es-MX", "scn", "ia", "te", "fur", "ga-IE", "ach", "ru", "tl", "en-GB", "meh", "mix", "hye", "hy-AM", "gu-IN", "xh", "ro", "hsb", "cak", "zh-CN", "hi-IN", "ckb", "uk", "sr", "brx", "en-CA", "frp", "ltg", "pt-PT", "si", "ml", "mk", "sat", "an", "lij", "kn", "bn-IN", "bs", "zh-TW", "my", "ar", "nb-NO", "gl", "gv", "hr", "pt-BR", "hu", "nl", "bg", "ks", "bn", "ast", "af", "ka", "de", "as", "az", "gd", "br", "skr", "ko", "fi", "crh", "son", "eo", "id", "fr", "sv-SE", "lg", "et", "fa", "lt", "ff", "or", "cy", "en-US", "eu", "bn-BD", "lo", "ne-NP", "rm", "dsb", "ta", "ace", "th", "pai", "tr", "wo", "pa-IN", "tg"]//@line 21 "$SRCDIR/browser/extensions/newtab/webext-glue/builtin-newtab.js"
